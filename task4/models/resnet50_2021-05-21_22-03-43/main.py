...
def train_remote():
    ...
    torch.manual_seed(123)
    transforms = Compose([MyPad(), Resize((256, 256)), CenterCrop(224), RandomHorizontalFlip(0.2),
    ...
    metric = AverageNonzeroTripletsMetric()
    loss_fn = TripletLoss(0.3)
    fit(train_loader, val_loader, model, loss_fn, adam, scheduler, 100, True, 1, backbone,
